...
if(isset($_COOKIE['bctref'])){
	$bcref = $mysqli->real_escape_string($_COOKIE['bctref']);
}
else {
	die();
}
...
// login helper with redirect_uri
    $helper = new FacebookRedirectLoginHelper("$domain/facebook_login2.php" );
try {
